...
export class AuthorizePage {
  ...
  constructor(page: Page) {
    ...
    this.eyeButton = page.locator(
      "//button[@class='btn-input btn-input-block']",
    );
    this.errorMessage = page.locator(
      "//ul//div[text()='Uh oh! Email or password is incorrect']",
    );
    this.tooltipEmailText = page.locator(
      "//span[@class='tooltip-text'][contains(., 'Uh oh! This') and contains(., 'isn’t an email')]",
    );
  }
